/**
 Script for creating the world map
 */
...
//import {showQuizPopup} from "../content/quiz-popup";
...
Mario.MapState.prototype.GenerateLevel = function() {
    ...
    // Hier wird abgesichert, dass nur 5 Level generiert werden für die Map
    var levelCount = 0;
...
Mario.MapState.prototype.LevelWon = function() {
    ...
    this.LevelCounter++; // Wenn Level gewonnen, wird LevelCounter hochgesetzt
    this.RenderStatic();
};
...
/**
 ...
 Hier werden die Lerninhalte und Quizelemente getriggert
**/
Mario.MapState.prototype.CheckForChange = function(context) {

    if (this.WorldNumber === 1) { // wenn der Spieler gewinnt...
